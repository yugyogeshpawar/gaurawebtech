...
$(document).ready(function() {
    ...
    // ------------ projects-slider13 -----------
    var swiper = new Swiper('.testimonials-slider16 .swiper-container', {
        spaceBetween: 30,
        // centeredSlides: true,
        slidesPerView: 3,
        direction: 'vertical',
    ...
    // ------------ tc-header-slider1 -----------
    var swiper = new Swiper('.tc-testimonials-st17 .testi-slider', {
        slidesPerView: 3,
        spaceBetween: 30,
        centeredSlides: true,
        speed: 1500,
        pagination: false,
        navigation: {
            nextEl: '.tc-testimonials-st17 .swiper-button-next',
            prevEl: '.tc-testimonials-st17 .swiper-button-prev',
        },
        mousewheel: false,
        keyboard: true,
        autoplay: {
    ...
    // instagram-slider
    var swiper = new Swiper('.tc-instagram-st17 .instagram-slider', {
        slidesPerView: 5,
        spaceBetween: 0,
        centeredSlides: true,
        pagination: false,
    ...
    // ------------ tc-testimonials-st12 -----------
    var swiper = new Swiper('.tc-testimonials-st12 .testi-slider', {
        slidesPerView: 1,
        spaceBetween: 30,
        // centeredSlides: true,
        speed: 1500,
